...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class YoutubeLibraryAccessors extends SubDependencyFactory {
        private final YoutubeAndroidLibraryAccessors laccForYoutubeAndroidLibraryAccessors = new YoutubeAndroidLibraryAccessors(owner);

        public YoutubeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>youtube.android</b>
         */
        public YoutubeAndroidLibraryAccessors getAndroid() {
            return laccForYoutubeAndroidLibraryAccessors;
        }

    }

    public static class YoutubeAndroidLibraryAccessors extends SubDependencyFactory {
        private final YoutubeAndroidPlayerLibraryAccessors laccForYoutubeAndroidPlayerLibraryAccessors = new YoutubeAndroidPlayerLibraryAccessors(owner);

        public YoutubeAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>youtube.android.player</b>
         */
        public YoutubeAndroidPlayerLibraryAccessors getPlayer() {
            return laccForYoutubeAndroidPlayerLibraryAccessors;
        }

    }

    public static class YoutubeAndroidPlayerLibraryAccessors extends SubDependencyFactory {

        public YoutubeAndroidPlayerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>api</b> with <b>com.google.android.youtube:youtube-android-player-api</b> coordinates and
         * with version reference <b>youtubeAndroidPlayerApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getApi() {
            return create("youtube.android.player.api");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>youtubeAndroidPlayerApi</b> with value <b>1.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getYoutubeAndroidPlayerApi() { return getVersion("youtubeAndroidPlayerApi"); }
